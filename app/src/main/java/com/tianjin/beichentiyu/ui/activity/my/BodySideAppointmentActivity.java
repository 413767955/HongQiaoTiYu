...
public class BodySideAppointmentActivity extends BaseActivity {
    public static void toActivity(Context context){
        context.startActivity(new Intent(context,BodySideAppointmentActivity.class));
    }
    ...
    private List<androidx.core.util.Pair<String,String>> mDateList;
    ...
    private void initDateRv(){
        ...
        mDateAdapter = new BaseAdapter<androidx.core.util.Pair<String,String>>(R.layout.adapter_menu_date,mDateList) {
            @Override
            protected void convert(BaseViewHolder holder, androidx.core.util.Pair<String,String> item) {
    ...
    private void initDataRv(){
        mDataAdapter = new BaseAdapter<AppointmentPhysicalBean.ListBean>(R.layout.adapter_body_side,mDataList) {
            @Override
            protected void convert(BaseViewHolder holder, AppointmentPhysicalBean.ListBean item) {
                ImageView ivIcon = holder.getView(R.id.iv_icon);
                TextView tvTitle = holder.getView(R.id.tv_title);
                TextView tvTime = holder.getView(R.id.tv_time);
                tvTitle.setText(item.getPhy_name());
    ...
    private void loadData(String date){
        ...
        ApiManager.getBusinessService().getMemLogAppointmentPhysicalList(tel, nonstr, date)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new BaseObserver<AppointmentPhysicalBean>() {
                    @Override
                    protected void onSuccees(AppointmentPhysicalBean bean) throws Exception {
